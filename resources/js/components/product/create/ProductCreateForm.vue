      ...
      <form @submit.prevent="createProduct" class="product-form">
        ...
        <fieldset class="form-section">
          ...
          <div class="form-group">
            ...
            <span v-if="errors['translations.es.name']" class="error-text">{{ errors['translations.es.name'][0] }}</span>
          </div>
  
          <div class="form-group">
            <label for="description_es">Descripción (ES):</label>
            <textarea id="description_es" v-model="form.translations.es.description" rows="4" class="form-control"></textarea>
            <span v-if="errors['translations.es.description']" class="error-text">{{ errors['translations.es.description'][0] }}</span>
          </div>
        </fieldset>
        ...
        <fieldset class="form-section">
          ...
          <div class="form-group">
            ...
            <span v-if="errors['price.price']" class="error-text">{{ errors['price'][0] }}</span>
          </div>
        </fieldset>
